...
/** Horizontal scroll is on the wrapper so narrow screens never break layout. */
...
const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr
      ref={ref}
      className={cn('border-b border-border transition-colors hover:bg-primary-light/40 data-[state=selected]:bg-primary-light', className)}
      {...props}
    />
  ),
)
